            	...
            	<div class="login-container">
					<c:if test="${ empty loginMember }">
					  <div>
                  	  	...
                  	  	<button type="button" id="si" class="btn btn-outline-secondary" onclick="location.href='${ path }/member/signup'">회원가입</button>
                   	 	<button type="button" id="so"  class="btn btn-outline-secondary" onclick="location.href='${ path }/member/login'">로그인</button>             
					</c:if>
            	</div>
           </div>
    </nav>
