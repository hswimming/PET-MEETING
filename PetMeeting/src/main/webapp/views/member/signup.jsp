                ...
                <div class="signup_content">
                    <div class="">
                        ...
                        <div id="getPwd">
                            ...
                            비밀번호는 8~16자의 영문 대소문자, 숫자, 특수문자만 사용 가능합니다.</span>
                        </div>
                        <div id="getrePwd">
                            <h3 class="infotitle">
...
// 		  const pwdRegExp = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*])[A-Za-z\d!@#$%^&*]{8,16}$/;
...
// 	  // 모든 값이 존재하고, 유효성 검사를 통과한 경우에만 통과
// 	  function checkInfo() {
// 	  	if (isValid()) {
// 	    	return true;
// 	  	} else {
// 	    event.preventDefault(); // submit 이벤트 취소
// 	    alert("입력한 값이 올바르지 않습니다. 다시 확인해주세요.");
// 	    return false;
// 	  	}
// 	  }
...
// 		닉네임 중복확인
		$('#checkDuplicateNick').on('click', () => {
			...
			if(nicknameRegExp.test(inputNickname)) {
				...
				alert("이름은 한글과 영문 대소문자만 사용 가능합니다.");
			}
		});
