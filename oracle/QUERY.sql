...
SELECT  WB.WB_NO, WB.WB_TITLE, M.M_NICKNAME, WB.WB_VIEWS, WB.WB_CONTENT, WB.CREATE_DATE, WB.MODIFY_DATE, WB.ORIGINAL_FILENAME, WB.RENAMED_FILENAME, D.D_NAME, D.D_KIND, D.D_SIZE, D.D_GENDER, D.NEUTERED, D.VACCINE
FROM WALKBOARD WB
...
-- 댓글 조회
SELECT R.WR_NO, R.WB_NO, R.WR_CONTENT, M.M_NICKNAME, R.CREATE_DATE, R.MODIFY_DATE
FROM WALKREPLY R
